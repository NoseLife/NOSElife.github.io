---
layout: post
title:  "The Awesome Template As A Foundation For Annotated Curated Reading List"
date:   2020-08-31 4:30:00
categories: template
---

First, we just surf and browse ... then we go beyond taking good notes and start re-factoring ... to tailor and improve the content and rewriting the course to better teach ourselves [and our future selves] ... with a plan to revisit topics later. The point is to go beyond just absorbing and copying, but to actively CURATE better forks of [AWESOME lists](https://github.com/topics/awesome).
